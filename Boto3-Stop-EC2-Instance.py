#This python script get Instance ID as input and stop the EC2 instance and display the current status of the instance as output
...
print("Sending stop command to the instance")
ec2resource.Instance(Instance_ID).stop()
