#This python script get Instance ID as input and terminate the EC2 instance and display the current status of the instance as output
...
import json
import warnings
warnings.warn("Note:\nThis script will delete the EC2 instance, an irreversible action\n")
...
ec2resource.Instance(Instance_ID).terminate()
